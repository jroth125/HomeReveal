      ...
      if (pathNames[1] === 'for-rent') {
        ...
        fetch(
          ...
          data.json().then(jsonData => {
            ...
            complaints.innerHTML = `<span class="nobreak" style="color: ${jsonData.length ? 'red': 'black'}; font-size: 16px; margin-left: 5px"><b>${jsonData.length} building complaints</b> (last 5 years)</span> 
            ...
            complaints.style = `background-color: ${jsonData.length ? '#FFFBB6': 'white'};`;
